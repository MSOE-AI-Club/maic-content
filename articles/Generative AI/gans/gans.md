...
If you have MATLAB and want to try training your own GAN, the Deep Learning Toolbox [is able to do it](https://www.mathworks.com/help/deeplearning/ug/train-generative-adversarial-network.html).